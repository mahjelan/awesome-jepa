...
export const Sources: FC<{ sources: Source[] | null }> = ({ sources }) => {
  return (
    <Wrapper
      title={
        <>
      ...
      content={
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {sources === null ? (
            ...
            <div className="text-sm text-zinc-500 col-span-2 sm:col-span-4">
              Sources are not available when using direct OpenAI responses.
            </div>
          )}
        </div>
      }
